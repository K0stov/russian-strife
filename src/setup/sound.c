...
void ConfigSound(void)
{
    ...
    window = TXT_NewWindow("ìα±≥≡εΘΩΦ τΓ≤Ωα");
    ...
    TXT_AddWidgets(window,
        TXT_NewSeparator("çΓ≤ΩεΓ√σ ²⌠⌠σΩ≥√"),
        TXT_NewRadioButton("Ä≥Ωδ■≈σφ√", &snd_sfxdevice, SNDDEVICE_NONE),
        ...
        TXT_If(gamemission == strife,
            TXT_NewConditional(&snd_sfxdevice, SNDDEVICE_SB,
                TXT_NewHorizBox(
                    TXT_NewStrut(4, 0),
                    TXT_NewCheckBox("ÆσΩ±≥ Γ ΣΦαδεπα⌡", &show_talk),
                    NULL))),

        TXT_NewSeparator("î≤τ√Ωα"),
        TXT_NewRadioButton("Ä≥Ωδ■≈σφα", &snd_musicdevice, SNDDEVICE_NONE),
        ...
        TXT_NewRadioButton("GUS (²∞≤δ ÷Φ )", &snd_musicdevice, SNDDEVICE_GUS),
        TXT_NewConditional(&snd_musicdevice, SNDDEVICE_GUS,
            TXT_MakeTable(2,
                TXT_NewStrut(4, 0),
                TXT_NewLabel("Éα±∩εδεµσφΦσ ∩α≥≈σΘ GUS: "),
                TXT_NewStrut(4, 0),
