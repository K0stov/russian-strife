...
static txt_button_t *GetLaunchButton(void)
{
    ...
    switch (gamemission)
    {
        ...
        case hexen:
            ...
            break;
        case strife:
            label = "æε⌡≡αφΦ≥ⁿ φα±≥≡εΘΩΦ Φ τα∩≤±≥Φ≥ⁿ STRIFE!";
            break;
        default:
...
void MainMenu(void)
{
    ...
    window = TXT_NewWindow("âδαΓφεσ ∞σφ■");

    TXT_SetWindowHelpURL(window, WINDOW_HELP_URL);

    TXT_AddWidgets(window,
        TXT_NewButton2("ìα±≥≡εΘΩΦ ²Ω≡αφα",
                       (TxtWidgetSignalFunc) ConfigDisplay, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ τΓ≤Ωα",
                       (TxtWidgetSignalFunc) ConfigSound, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ ΩδαΓΦα≥≤≡√",
                       (TxtWidgetSignalFunc) ConfigKeyboard, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ ∞√°Φ",
                       (TxtWidgetSignalFunc) ConfigMouse, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ ΣµεΘ±≥ΦΩα/πσΘ∞∩αΣα",
                       (TxtWidgetSignalFunc) ConfigJoystick, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ ±εΓ∞σ±≥Φ∞ε±≥Φ",
                       (TxtWidgetSignalFunc) CompatibilitySettings, NULL),
        GetLaunchButton(),
        TXT_NewStrut(0, 1),
        TXT_NewButton2("ìα≈α≥ⁿ ±σ≥σΓ≤■ Φπ≡≤",
                       (TxtWidgetSignalFunc) StartMultiGame, NULL),
        TXT_NewButton2("Å≡Φ±εσΣΦφΦ≥ⁿ±  Ω ±σ≥σΓεΘ Φπ≡σ",
                       (TxtWidgetSignalFunc) JoinMultiGame, NULL),
        TXT_NewButton2("ìα±≥≡εΘΩΦ ±σ≥σΓεΘ Φπ≡√",
                       (TxtWidgetSignalFunc) MultiplayerConfig, NULL),
        NULL);

    quit_action = TXT_NewWindowAction(KEY_ESCAPE, "é√⌡εΣ");
    warp_action = TXT_NewWindowAction(KEY_F2, "ô≡εΓσφⁿ");
...
static void InitTextscreen(void)
{
    ...
    if (!TXT_Init())
    {
        fprintf(stderr, "ìσΓετ∞εµφε ΦφΦ÷ΦαδΦτΦ≡εΓα≥ⁿ Φφ≥σ≡⌠σΘ±\n");
        exit(-1);
    }
