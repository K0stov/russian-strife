                               ...
                               TXT_UNCAST_ARG(sizes_table))
{
    ...
    TXT_AddWidget(sizes_table, TXT_NewSeparator("Éατ∞σ≡ εΩφα"));
                                  ...
                                  TXT_UNCAST_ARG(sizes_table))
{
    ...
    window = TXT_NewWindow("äε∩εδφΦ≥σδⁿφ√σ φα±≥≡εΘΩΦ ²Ω≡αφα");
    ...
    TXT_AddWidgets(window,
        ar_checkbox = TXT_NewCheckBox("öΦΩ±Φ≡εΓα≥ⁿ ±εε≥φε°σφΦσ ±≥ε≡εφ",
                                      &aspect_ratio_correct),
        TXT_If(gamemission == heretic || gamemission == hexen
            || gamemission == strife,
            TXT_NewCheckBox("â≡α⌠Φ≈σ±Ωα  ταπ≡≤τΩα", &graphical_startup)),
        TXT_If(gamemission == doom || gamemission == heretic
            || gamemission == strife,
            TXT_NewCheckBox("ÅεΩατ√Γα≥ⁿ ²Ω≡αφ ENDOOM ∩≡Φ Γ√⌡εΣσ",
                            &show_endoom)),
#ifdef HAVE_LIBPNG
        TXT_NewCheckBox("æε⌡≡αφ ≥ⁿ ±Ω≡Φφ°ε≥√ Γ ⌠ε≡∞α≥σ PNG",
                        &png_screenshots),
#endif
        NULL);
...
void ConfigDisplay(void)
{
    ...
    // Open the window
    window = TXT_NewWindow("ìα±≥≡εΘΩΦ ²Ω≡αφα");
    TXT_SetWindowHelpURL(window, WINDOW_HELP_URL);

    // Build window:
    TXT_AddWidgets(window,
        TXT_NewCheckBox("Åεδφε²Ω≡αφφ√Θ ≡σµΦ∞", &fullscreen),
    ...
    advanced_button = TXT_NewWindowAction('a', "äε∩. φα±≥≡εΘΩΦ");
