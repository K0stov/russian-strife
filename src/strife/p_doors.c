...
int EV_DoLockedDoor(line_t* line, vldoor_e type, mobj_t* thing)
{
    ...
    case 133:
        ...
        {
            p->message = DEH_String("You need an id card"); // [rus] Нужна личная карта
    ...
    case 135:
        ...
        {
            p->message = DEH_String("You need an id badge"); // [rus] Нужна личная карта
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 137:
        ...
        {
            p->message = DEH_String("ye;ty ghjgecr"); // [rus] Нужен пропуск
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 164:
        ...
        {
            p->message = DEH_String("ye;ty pjkjnjq rk.x"); // [rus] Нужен золотой ключ
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 163:
        ...
        {
            p->message = DEH_String("ye;ty ctht,hzysq rk.x"); // [rus] Нужен серебряный ключ
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 162:
        ...
        {
            p->message = DEH_String("ye;ty kfneyysq rk.x"); // [rus] Нужен латунный ключ
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 168:
        ...
        {
            p->message = DEH_String("jngtxfnjr herb yt hfcgjpyfy"); // [rus] Отпечаток руки не распознан
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 171:
        ...
        {
            p->message = DEH_String("ye;ty rk.x jn n.hmvs"); // [rus] Нужен ключ от тюрьмы
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
    ...
    case 172:
        ...
        {
            p->message = DEH_String("ye;ty rk.x"); // [rus] Нужен ключ
            S_StartSound(NULL, sfx_oof);
            return 0;
        }
        break;
...
void EV_VerticalDoor(line_t* line, mobj_t* thing)
{
    ...
    case 32:  // D1 ID Card door
        ...
        {
            player->message = DEH_String("lkz jnrhsnbz ye;yf kbxyfz rfhnf"); // [rus] Для открытия нужна личная карта
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 34:  // D1 Pass Card door
        ...
        {
            player->message = DEH_String("lkz jnrhsnbz ye;ty ghjgecr"); // [rus] Для открытия нужен пропуск
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 33:  // D1 ID Badge door
        ...
        {
            player->message = DEH_String("You need an id badge to open this door"); // [rus] Для открытия нужна личная карта
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 161: // DR brass key door
        ...
        {
            player->message = DEH_String("ye;ty kfneyysq rk.x"); // [rus] Нужен латунный ключ
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 160: // DR silver key door
        ...
        {
            player->message = DEH_String("ye;ty ctht,hzysq rk.x"); // [rus] Нужен серебряный ключ
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 159: // DR gold key door
        ...
        {
            player->message = DEH_String("ye;ty pjkjnjq rk.x"); // [rus] Нужен золотой ключ
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 165:
        player->message = DEH_String("gj[j;t< 'nj yt hf,jnftn"); // [rus] Похоже, это не работает
        S_StartSound(NULL, sfx_oof);
        return;
    ...
    case 166: // DR Hand Print door
        ...
        {
            player->message = DEH_String("jngtxfnjr herb yt hfcgjpyfy"); // [rus] Отпечаток руки не распознан
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 169: // DR Base key door
        ...
        {
            player->message = DEH_String("ye;ty rk.x"); // [rus] Нужен ключ
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 205: // DR "Only in retail"
        player->message = DEH_String("'nf kjrfwbz ljcnegyf njkmrj " // [rus] Эта локация доступна только
                                     "d gjkyjq dthcbb buhs"); // [rus] в полной версии Strife
        S_StartSound(NULL, sfx_oof);
        return;
    ...
    case 213: // DR Chalice door
        ...
        {
            player->message = DEH_String("ye;yf xfif!"); // [rus] Нужна чаша!
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
    ...
    case 232: // DR Oracle Pass door
        ...
        {
            player->message = DEH_String("ye;ty ghjgecr jhfrekf!"); // [rus] Нужен пропуск Оракула!
            S_StartSound(NULL, sfx_oof);
            return;
        }
        break;
...
void EV_SlidingDoor(line_t* line, mobj_t* thing)
{
    ...
    if(!door)
    {
        ...
        if(door->whichDoorIndex < 0)
            I_Error(DEH_String("yt pflfys ntrcnehs lkz hfpldb;yjq ldthb!")); // [rus] Не заданы текстуры для раздвижной двери!
