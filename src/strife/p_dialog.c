...
static rndmessage_t rndMessages[] = 
{
    // Peasants
    {
        ...
        10,
        {
            "gj;fkeqcnf< yt nhjufq vtyz>", // [rus] Пожалуйста, не трогай меня.
            
            "tckb ns [jxtim elfhbnm vtyz< nj \n" // [rus] Если ты хочешь ударить меня, то
            "z yt cnj. ndjb[ ecbkbq>", // [rus] я не стою твоих усилий.
            
            "z ybxtuj yt pyf.>", // [rus] Я ничего не знаю.
            
            "e[jlb< bkb z gjpjde cnhf;e!", // [rus] Уходи, или я позову стражу!
            ...
            "cke;bntktq>", // [rus] служителей.

            "jhlty lth;bn nen dct gjl pfvrjv>", // [rus] Орден держит тут все под замком.

            ",tp hfphtitybz cnhf;tq gjhzlrf b \n" // [rus] Без разрешения стражей порядка
            "ifue cnegbnm ytkmpz>", // [rus] и шагу ступить нельзя.

            "z cks[fk< xnj jhlty cthmtpyj \n" // [rus] Я слыхал, что Орден серьезно
            "j,tcgjrjty ltqcndbzvb \n" // [rus] обеспокоен действиями
            "gjdcnfywtd d 'njv hfqjyt>" // [rus] повстанцев в этом районе.
        }
    },
    // Rebel
    {
        ...
        10,
        {
            ...
            "gkfys v'qcbkf cnfyjdzncz zcys>", // [rus] Планы Мэйсила становятся ясны.

            "yt ,tcgjrjqcz> vs chfpe pf nj,jq>", // [rus] Не беспокойся. Мы сразу за тобой.

            "lth;bcm gjlfkmit jn 'nb[ \n" // [rus] Держись подальше от этих
            ",jkmib[ hj,jnjd> jyb b vjrhjuj \n" // [rus] больших роботов. Они и мокрого
            "vtcnf jn nt,z yt jcnfdzn!", // [rus] места от тебя не оставят!
            ...
            "rfrbv jy ljk;ty ,snm>", // [rus] каким он должен быть.
            ...
            "b cyfhe;b>", // [rus] и снаружи.

            "gjrf [jnz ,s jlby bp yfc tot \n" // [rus] Пока хотя бы один из нас еще
            "lsibn< vs ytgj,tlbvs>" // [rus] дышит, мы непобедимы.
        }
    },
    // Acolyte
    {
    ...
    // Beggar
    {
        ...
        10,
        {
            "e nt,z yt yfqltncz vtkjxb lkz ,tlyzrf?", // [rus] У тебя не найдется мелочи для бедняка?

            "xnj ecnfdbkcz< ytpyfrjvtw?", // [rus] Что уставился, незнакомец?

            "e nt,z ckexfqyj yt yfqltncz ytvyjuj kbiytq tls?", // [rus] У тебя случайно не найдется немного лишней еды?

            "ds< k.lb c gjdth[yjcnb< ybrjulf yt \n" // [rus] Вы, люди с поверхности, никогда не
            "                                                                 "
            "                                      gjqvtnt yfc>", // [rus] поймете нас.

            "[f! 'nf ukegfz cnhf;f ybrjulf yt yfqltn yfc> \n" // [rus] Ха! Эта глупая стража никогда не найдет нас.
            "jyb lf;t yt pyf.n< xnj vs ceotcndetv>", // [rus] Они даже не знают, что мы существуем.

            "jlyf;ls dctv< rnj yt cke;bn jhltye< ghbltncz ghbcjtlbybnmcz " // [rus] Однажды всем, кто не служит Ордену, придется присоединиться
            "  r yfv>", // [rus] к нам.

            "cvjnhb crjkmrj dktptn< yj pyfq< xnj rjulf-yb,elm nfr ,eltn dsukzltnm b ndjt kbwj>", // [rus] Смотри сколько влезет, но знай, что когда-нибудь так будет выглядеть и твое лицо.

            // Note: "NOTHING THING" is an authentic typo
            "ybxnj nfr yt dsdjlbn bp ct,z< rfr \n" // [rus] Ничто так не выводит из себя, как
            ",jkney c gjdth[yjcnb!", // [rus] болтун с поверхности!

            "jhlty ,scnhj hfcghfdbncz c ndjbv ,tccbkmysv cjghjnbdktybtv>", // [rus] Орден быстро расправится с твоим бессильным сопротивлением.

            "gjjcnjhj;ytt< xtkjdtr c gjdth[yjcnb> vs pyftv< rnj yfi dhfu!" // [rus] Поосторожнее, человек с поверхности. Мы знаем, кто наш враг!
        }
    },
    // Templar
    {
        ...
        10,
        {
            ...
            "jpyfxftn dcnhtnbnm pf,dtybt!", // [rus] означает встретить забвение!

            "jhlty jxbcnbn vbh jn ckf,s[ \n" // [rus] Орден очистит мир от слабых
            "b gjhjxys[!", // [rus] и порочных!

            "gjlxbybcm djkt [jpztd!", // [rus] Подчинись воле хозяев!
            ...
            "ckf,svb le[jv>", // [rus] слабыми духом.
            ...
            "ghfdtlys[> ghbcjtlbybcm r yfv!", // [rus] праведных. Присоединись к нам!

            "jhlty pfoboftn cdjb[>", // [rus] Орден защищает своих.

            "cke;bntkb? bv tot njkmrj \n" // [rus] Служители? Им еще только
            "ghtlcnjbn ephtnm gjlkbyyjt \n" // [rus] предстоит узреть подлинное
            "dtkbxbt jhltyf>", // [rus] величие Ордена.
...
void P_DialogDoChoice(int choice)
{
    ...
    if(choice != dialogmenu.numitems - 1 && candochoice)
    {
                              ...
                              item))
        {
            ...
            message = DEH_String("rf;tncz< nt,t [dfnbn!"); // [rus] Кажется, тебе хватит!
...
void P_DialogStart(player_t *player)
{
    ...
    else
    {
        ...
        if(mobjinfo[linetarget->type].name)
            ...
            dialogname = DEH_String("ujhj;fyby"); // default name - like Joe in Doom 3 :P // [rus] Горожанин
    }
    ...
    {
    case 2:
        byetext = DEH_String("gjrf!"); // [rus] Пока!
        break;
    case 1:
        byetext = DEH_String("cgfcb,j< gjrf!"); // [rus] Спасибо, пока!
        break;
    default:
    case 0:
        byetext = DEH_String("lj dcnhtxb!"); // [rus] До встречи!
        break;
    }
